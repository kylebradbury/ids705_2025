...
::: {layout-nrow=1}
![Kian Bagherlee ([{{< fa envelope >}}](mailto: kian.bagherlee@duke.edu), [{{< fa brands linkedin >}}](https://www.linkedin.com/in/kian-bagherlee/))](img/kian_bagherlee.jpg){fig-align="left"}
