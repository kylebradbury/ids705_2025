...
- [Duke Compute Cluster](https://oit-rc.pages.oit.duke.edu/rcsupportdocs/). This server provides on-demand access to GPUs for computation through a centralized Duke server. You have access to this resource for the semester. Further instructions on how to use this tool will be provided.
