...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, bottomtitle=1mm, breakable, leftrule=.75mm, colframe=quarto-callout-important-color-frame, opacityback=0, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important note}, arc=.35mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomtitle=1mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, opacityback=0, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important note}, arc=.35mm, opacitybacktitle=0.6, left=2mm, toprule=.15mm, bottomrule=.15mm]
