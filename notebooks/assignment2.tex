...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, breakable, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, titlerule=0mm, coltitle=black, bottomrule=.15mm, left=2mm]
