...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, titlerule=0mm, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacityback=0, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, leftrule=.75mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white]
