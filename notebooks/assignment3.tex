...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, breakable, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, toptitle=1mm, left=2mm, coltitle=black, titlerule=0mm, colback=white, colbacktitle=quarto-callout-note-color!10!white]
