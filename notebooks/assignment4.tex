...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, rightrule=.15mm, breakable, toptitle=1mm, left=2mm, leftrule=.75mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm]
