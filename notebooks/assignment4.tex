...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, opacityback=0, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, arc=.35mm, colback=white, toptitle=1mm, leftrule=.75mm, breakable, bottomtitle=1mm]
