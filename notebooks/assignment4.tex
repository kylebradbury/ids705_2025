...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, leftrule=.75mm, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, bottomrule=.15mm, toptitle=1mm, breakable, arc=.35mm, left=2mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6]
