...
<table class="table table-hover">
  ...
  <tr>
    ...
    <td class="date">Thursday<br> Jan 11</td>
    <td>
  ...
  <tr class="table-primary">
    <td><b></b></td>
    <td class="date">Monday <br> Jan 15</td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Jan 16</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Jan 18</td>
    <td>
  ...
  <tr class="table-warning">
    ...
    <td class="date"> Monday<br> Jan 22</td>
    <td><b>Assignment #1 Due (at 9pm)</b><br> Probability, Linear Algebra, & Computational Programming</td>
    <td></td>
    <td>
      <a href="https://github.com/kylebradbury/ids705/blob/main/assignments/Assignment_1.ipynb">[assignment]</a><br>
      <a href="https://github.com/kylebradbury/ids705/blob/main/assignments/Assignment_1_Q12_Example.ipynb">[sample Q12]</a><br>
      <!-- [submit] -->
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Jan 23</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Jan 25</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Jan 30</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Feb 1</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date"> Monday<br>Feb 5</td>
    <td><b>Assignment #2 Due (at 9pm)</b><br>Supervised Machine Learning Fundamentals</td>
    <td></td>
    <td>
      <!-- [assignment] <br> -->
      <a href="https://github.com/kylebradbury/ids705/blob/main/assignments/Assignment_2.ipynb">[assignment]</a><br>
      <!-- [submit] -->
      <a href="https://www.gradescope.com/">[submit]</a>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Feb 6</td>
    <td>
    ...
    <td>
      <!-- Link to reading -->
      <a href="https://edstem.org/us/courses/50969/resources?download=33263">Link to reading</a>
    </td>
    <td>
      <!-- [slides] -->
  ...
  <tr>  
    ...
    <td class="date">Thursday <br> Feb 8</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Feb 13</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Feb 15</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date"> Monday <br> Feb 19</td>
    <td><b>Assignment #3 Due (at 9pm)</b><br>Supervised learning model training and evaluation</td>
    <td></td>
    <td>
      <!-- [assignment] <br> -->
      <a href="https://github.com/kylebradbury/ids705/blob/main/assignments/Assignment_3.ipynb">[assignment]</a><br>
      <!-- [submit] -->
      <a href="https://www.gradescope.com/">[submit]</a>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Feb 20</td>
    <td>
    ...
    <td>
      <!-- [slides] -->
      <a href="https://github.com/kylebradbury/ids705/raw/main/lectures/lecture12_kernel_methods.pdf">[slides]</a>
    </td>
  </tr>

  <tr>
    <td class="lecnum">Lecture 13</td>
    <td class="date">Thursday <br> Feb 22</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Feb 27</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Feb 29</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Tuesday<br>Mar 5</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Wednesday <br> Mar 6</td>
  ...
  <tr>
    ...
    <td class="date">Thursday<br>Mar 7</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date"> Friday <br> Mar 8 </td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Mar 19</td>
    <td>
      <b>Clustering I</b> <br>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Mar 21</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Tuesday <br> Mar 26</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Mar 28</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Sunday <br> Mar 31</td>
    <td><b>Assignment #5 Due (at 9pm)</b> <br> Kaggle Competition and Unsupervised Learning<br><b>Kaggle Competition Ends 9pm on Saturday Mar 30</b></td>
    <td></td>
    <td>
      <!-- [assignment] <br> -->
  ...
  <tr>
    ...
    <td class="date">Tuesday<br> Apr 2</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Wednesday <br> Apr 3 </td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Apr 4</td>
    <td>
  ...
  <tr>
    ...
    <td class="date">Thursday <br> Apr 9</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Tuesday <br> Apr 16</td>
    <td>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Sunday <br> Apr 21 </td>
    <td><b>Final Project Report Due (at 9pm)</b></td>
    <td></td>
    <td>
      <!-- [project] <br> -->
      <!-- [submit] -->
      <a href="https://kylebradbury.github.io/ids705/project.html#final-report">[project]</a><br>
      <a href="https://www.gradescope.com/">[submit]</a>
    </td>
  </tr>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Monday <br> Apr 22</td>
    <td><b>Final Project Peer Evaluation Due (at 9pm)</b></td>
    <td></td>
    <td>
      <!-- [project] -->
      <a href="https://kylebradbury.github.io/ids705/project.html#peer-evaluation">[project]</a><br>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Monday <br> Apr 22</td>
    <td><b>Final Project Repository Due (at 9pm)</b></td>
    <td></td>
    <td>
      <!-- [project] -->
      <a href="https://kylebradbury.github.io/ids705/project.html#github-repository">[project]</a><br>
      <a href="https://www.gradescope.com/">[submit]</a>
    </td>
  </tr>
  ...
  <tr class="table-warning">
    <td><b>Deliverable</b></td>
    <td class="date">Wednesday <br> Apr 24</td>
